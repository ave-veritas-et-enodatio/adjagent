...
Code is expected to meet the high standards of a senior staff engineer. This standard is grounded on a core principle: line count and complexity comprise a *COST* paid in exchange for the true value, which is *CAPABILITY*. The optimal outcome is inherently defined as maximum capability value for lowest cost in code line count & complexity.
...
If an additional constraints document is provided, validate against coding invariants and requirements specified there.
