...
**Memory**: `./.claude/agent-memory/marketing-comms-expert/` — record brand voice, audience definitions, positioning choices, naming patterns, messaging pillars, trademark considerations.
